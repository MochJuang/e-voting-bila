...
3. *Liveness detection* berhasil diterapkan sebagai lapisan keamanan tambahan untuk mencegah autentikasi palsu. Setelah wajah cocok, sistem menampilkan satu tantangan acak berupa menghadap ke kiri atau menghadap ke kanan, yang dinilai di sisi *backend* dari sudut kepala (*yaw*) hasil estimasi pose wajah. Dengan mewajibkan gerakan aktif yang dipilih secara acak, sistem dapat menolak media statis seperti foto atau video sehingga lebih tahan terhadap serangan *spoofing* dasar. Hal ini menjawab rumusan masalah ketiga.
...
2. Tantangan *liveness* dapat dikembangkan lebih lanjut dengan menambahkan gerakan lain (mis. senyum atau kedip mata) setelah metode deteksinya dikalibrasi agar lebih stabil, karena kualitas hasil verifikasi masih dipengaruhi oleh kondisi perangkat, pencahayaan, dan kestabilan posisi wajah.
