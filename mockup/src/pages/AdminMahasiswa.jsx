...
export default function AdminMahasiswa() {
  ...
  const saveForm = (e) => {
    ...
    if (formModal.isNew) {
      ...
      addVoter({ nim: formModal.nim, nama: formModal.nama, kelas: formModal.kelas, modeAkses: formModal.modeAkses })
    } else {
      updateVoter(formModal.nim, { nama: formModal.nama, kelas: formModal.kelas, modeAkses: formModal.modeAkses })
    }
    setFormModal(null)
  }
  ...
  const mockImport = () => {
    ...
    addVoter({ nim: `21417200${n}`, nama: `Mahasiswa Impor ${n}`, kelas: '-', modeAkses: 'mandiri' })
  }
